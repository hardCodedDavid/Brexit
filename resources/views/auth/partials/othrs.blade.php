...
<div class="container">
    <header class="c-card__header u-pt-large">
        ...
        <h1 class="u-h3 u-text-center u-mb-zero">Create Legal  Account</h1>
    </header>
    <form action="{{route('register.othrs')}}" method="POST">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="form-row">
                            <div class="row u-mb-small">
                                <div class="col-12 col-md-6">
                                    <div class="c-field">
                                        <label class="c-field__label" for="input1">Trade Name </label>
                                ...
                                <div class="col-12">
                                    <div class="c-field u-mb-small">
                                        ...
                                        <select class="c-select" name="sector">
                                            ...
                                            <option value="sai">Coporate</option>
                                            <option value="sai">State Owned</option>
                                            <option value="bc">Mining</option>
                                            <option value="fp">Defence</option>
                                            <option value="fp">Construction</option>
                                            <option value="fi">Others</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row u-mb-small">
                                <div class="col-12 col-md-6">
                                    <div class="c-field">
                                        ...
                                        <input class="c-input" id="input1" type="text" name="iban" placeholder="IBAN Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="c-field">
                                        ...
                                        <input class="c-input" id="input1" type="text" name="swift" placeholder="Swift Number">
                                    </div>
                                </div>
